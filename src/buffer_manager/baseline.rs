//! Baseline BufferManager implementation.
//!
//! Original implementation with:
//! - Single global `latch_table: Mutex<HashMap<...>>`
//! - Drop-based latch cleanup (prunes entries when strong_count == 2)
//!
//! This is the slowest variant at high thread counts due to global lock contention.
...
// ============================================================================
// LatchTableGuard (with Drop-based cleanup)
// ============================================================================
