...
README_ROWS: List[RowSpec] = [
    ...
    RowSpec(
        "Repeated Access MT x64",
        "Repeated Access MT x64 (1000 ops)",
        "throughput",
        "ops",
        lambda _: 1000,
    ),
    RowSpec(
        "Repeated Access MT x128",
        "Repeated Access MT x128 (1000 ops)",
        "throughput",
        "ops",
        lambda _: 1000,
    ),
    RowSpec(
        "Repeated Access MT x256",
        "Repeated Access MT x256 (1000 ops)",
        "throughput",
        "ops",
        lambda _: 1000,
    ),
    ...
    RowSpec(
        "Random MT x64 K=100",
        "Random MT x64 (K=100, 500 ops)",
        "throughput",
        "ops",
        lambda _: 500,
    ),
    RowSpec(
        "Random MT x128 K=100",
        "Random MT x128 (K=100, 500 ops)",
        "throughput",
        "ops",
        lambda _: 500,
    ),
    RowSpec(
        "Random MT x256 K=100",
        "Random MT x256 (K=100, 500 ops)",
        "throughput",
        "ops",
        lambda _: 500,
    ),
    ...
    RowSpec(
        "pin:t64",
        "Concurrent (64 threads, 1000 ops)",
        "throughput",
        "ops",
        lambda _: 64000,
    ),
    RowSpec(
        "pin:t128",
        "Concurrent (128 threads, 1000 ops)",
        "throughput",
        "ops",
        lambda _: 128000,
    ),
    RowSpec(
        "pin:t256",
        "Concurrent (256 threads, 1000 ops)",
        "throughput",
        "ops",
        lambda _: 256000,
    ),
    ...
    RowSpec(
        "hotset:t64_k4",
        "Concurrent Hotset (64 threads, K=4, 1000 ops)",
        "throughput",
        "ops",
        lambda _: 64000,
    ),
    RowSpec(
        "hotset:t128_k4",
        "Concurrent Hotset (128 threads, K=4, 1000 ops)",
        "throughput",
        "ops",
        lambda _: 128000,
    ),
    RowSpec(
        "hotset:t256_k4",
        "Concurrent Hotset (256 threads, K=4, 1000 ops)",
        "throughput",
        "ops",
        lambda _: 256000,
    ),
