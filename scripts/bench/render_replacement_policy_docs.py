...
README_ROWS: List[RowSpec] = [
    RowSpec("Pin/Unpin hit latency (P1)", "Pin/Unpin (hit)", "latency", ""),
    RowSpec("Cold pin latency (P1)", "Cold Pin (miss)", "latency", ""),
    RowSpec(
        "Sequential Scan throughput (P2)",
    ...
    RowSpec(
        "Repeated Access MT x4 throughput (P2)",
    ...
    RowSpec(
        "Repeated Access MT x16 throughput (P2)",
    ...
    RowSpec(
        "Random MT x4 K=10 throughput (P2)",
    ...
    RowSpec(
        "Random MT x16 K=10 throughput (P2)",
    ...
    RowSpec(
        "Random MT x4 K=50 throughput (P2)",
    ...
    RowSpec(
        "Random MT x16 K=50 throughput (P2)",
    ...
    RowSpec(
        "Random MT x4 K=100 throughput (P2)",
    ...
    RowSpec(
        "Random MT x16 K=100 throughput (P2)",
